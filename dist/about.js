    ...
    */
    ...
    function AboutContent() {
        ...
        */
        ...
        { name: "Mashud_1", age: 25 }, { name: "Mashud_2", age: 35 }, { name: "Mashud_3", age: 45 }, { name: "Mashud_4", age: 55 }, { name: "Mashud_5", age: 65 }];
        // myArray.push(5);
        ...
        var content = document.getElementsByClassName("content"); // array of elements not string
        ...
        */
        ...
        var myFarouriteThingsList = ["Video Games", "Movies", "Cars", "Space Flight"];
        ...
        myFarouriteThingsList.forEach(function (thing) {
